...
class AuthApiService{
  ...
  Future<String> getOTP(String countryMobileCode, String mobileNumber, String deviceId) async {
  ...
  Future<String> registerUser(String countryCode,String mobileNumber,String deviceId) async {
    final http.Response response = await http.post(
